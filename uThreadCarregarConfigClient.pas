...
begin
  try
    ...
    FQuery.SQL.Text := 'SELECT * FROM config_dtc where nome_db_client <> '''' LIMIT 1'; // Pega apenas um registro
    FQuery.Open;
    ...
    on E: Exception do
      Synchronize(
        ...
        FrmPrincipal.WriteLogFormatted('ERRO', '1', '[CLIENT SALVAR CONFIG] Erro ao carregar dados: ' + E.Message);
        end);
  end;
end;
